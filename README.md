...
| **Vanilla JavaScript** | Navigation, quizzes, progress tracking, SVG rendering |
| **Tone.js** (CDN) | Web Audio API — violin sample playback |
| **MusyngKite Soundfont** | High-quality violin audio samples |
...
The academy uses a premium, conservatory-inspired aesthetic:

- **Color Palette:** Dark charcoal, gold, cream, crimson, and forest green
- **Typography:** Playfair Display (headings), Cormorant Garamond (body), JetBrains Mono (code/labels)
- **UI Elements:** Gold-accented content blocks, dark exercise boxes, interactive fingerboard SVGs, animated note toasts

---

## 📚 Methodology Sources

This curriculum draws from the traditions of:
...
- **Juilliard School** & **Trinity College London** — Curriculum structure
...
- [MusyngKite Soundfont](https://gleitz.github.io/midi-js-soundfonts/) — Violin samples
- [Google Fonts](https://fonts.google.com/) — Typography
- [IMSLP](https://imslp.org/) — Public domain music scores referenced throughout

---

<p align="center">
  <em>"The road to Parnassus is long, but every step taken with patience and diligence is a step upward."</em><br>
  — J.J. Fux, 1725
</p>
